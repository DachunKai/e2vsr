...
#input list is ['datasets/CED/HR/CED_simple/simple_rabbits', 'datasets/CED_3/LRx4/CED_simple/simple_rabbits']
        ...
        with open(event_list[idx], 'r') as f:
            ...
            if len(lines) == 1:
                ...
                if idx == (len(event_list) - 1):
                    ...
                    print(f"remove one image file {images_folder}/{(idx+1):06d}.png")
                    break
                ...
                os.remove(osp.join(images_folder, f'{(idx+1):06d}.png'))
                print(f"remove empty image file {images_folder}/{(idx+1):06d}.png")
...
if __name__ == "__main__":
    ...
    root_path = 'datasets/CED_3/LRx2'

    pathlist = []
    for root, subdir, _ in os.walk(root_path):
        if 'images' in subdir:
            former = osp.join('datasets/CED/HR', root.split('/CED_3/LRx2/')[1])
